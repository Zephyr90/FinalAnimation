...
public class MainActivity extends AppCompatActivity
    ...
    Toolbar toolbar;
    @BindView(R.id.btn_md_animator)
    Button btnMdAnimator;
    ...
    @OnClick(R.id.btn_md_animator)
    void onMdAnimatorClick() {
        MDAnimatorActivity.startMDAnimatorActivity(this);
    }

    @OnClick(R.id.btn_view_animation)
    void onViewAnimation() {
        ViewAnimationActivity.start(this);
    }

    @OnClick(R.id.btn_value_animator)
    void onValueAnimator() {
        ValueAnimatorActivity.start(this);
//        CustomDrawableActivity.start(this);
    }
